...
{
public:
        Rectangle(const double a_in, const double b_in, const vivid::Color& color_in=vivid::Color(QUVIZ_DEFAULT_COLOR), const double angle_in = 0.,
                  const Point& center_in=Eigen::Vector3d::Zero(), const Point& normal_in=Eigen::Vector3d::UnitZ()) :
