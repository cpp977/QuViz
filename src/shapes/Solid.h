...
public:
        Solid(const Point& r_axis_in = Eigen::Vector3d::Zero(), const double r_angle_in=0.,
              const Point& center_in=Eigen::Vector3d::Zero(), const vivid::Color& color_in=vivid::Color(QUVIZ_DEFAULT_COLOR)) : Object(center_in,color_in), r_axis(r_axis_in), r_angle(r_angle_in) {};
